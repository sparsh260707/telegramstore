...
async def send_join_message(message: types.Message):
    ...
    kb.row(
        types.InlineKeyboardButton(text="📢 𝖴𝗉𝖽𝖺𝗍𝖾𝗌", url=f"https://t.me/Idstore_official"),
